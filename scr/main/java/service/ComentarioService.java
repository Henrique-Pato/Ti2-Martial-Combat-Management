...
public class ComentarioService {
  private ComentarioDAO lingDAO = new ComentarioDAO();
  private String form;
  ...
  public void makeForm(int tipo, Comentario comentario, int orderBy) {
    String nomeArquivo = Path.toFile(Path.Web.COMENTARIO);
    form = "";
    String list = "";
    try {
    ...
    List<Comentario> lings = lingDAO.get();
    // incorreto
    for (Comentario lgs : lings) {
